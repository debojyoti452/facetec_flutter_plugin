...
public class Config {
    ...
    public static String DeviceKeyIdentifier = "d0WNgqux0qh50fpaf3KrbBnZCZjT7R3K";
...
//    public static String BaseURL = "-";
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
        ...
        int borderColor = Color.parseColor("#c4c4c4");
        int ovalColor = Color.parseColor("#c8c8c8");
        int dualSpinnerColor = Color.parseColor("#c8c8c8");
        int textColor = Color.parseColor("#000000");
        int buttonAndFeedbackBarColor =  Color.parseColor("#e80766");
        int buttonAndFeedbackBarTextColor = Color.parseColor("#ffffff");
        int buttonColorHighlight = Color.parseColor("#ffffff");
        int buttonColorDisabled = Color.parseColor("#f9d7d7");

        // For Frame Corner Radius Customization
        int frameCornerRadius = 10;
